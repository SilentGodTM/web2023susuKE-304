...
describe('es6', () => {
    ...
    describe('#Dictionary', () => {
        ...
        it('ошибка при добавлении null ключа', () => {
          const dic = new core.Dictionary();
          assert.throws(() => dic.addWord(null, 'value'), Error);
        });
      
        it('ошибка при добавлении undefined значения', () => {
          const dic = new core.Dictionary();
          assert.throws(() => dic.addWord('key', undefined), Error);
        });
      
        it('ошибка при добавлении числового ключа', () => {
          const dic = new core.Dictionary();
          assert.throws(() => dic.addWord(123, 'value'), Error);
        });
      
        it('ошибка при добавлении числового значения', () => {
          const dic = new core.Dictionary();
          assert.throws(() => dic.addWord('key', 456), Error);
        });
      });
});
